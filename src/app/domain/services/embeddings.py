...
from app.infrastructure.database.models.message import ChannelMessageORM
from app.infrastructure.database.models.repositories import upsert_message_embedding
