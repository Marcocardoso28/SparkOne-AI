...
from app.infrastructure.database.models.events import EventStatus
from app.infrastructure.database.models.repositories import create_event
    ...
    async def handle(self, payload: ChannelMessage) -> dict[str, Any]:
        ...
        if self._google and self._calendar_id:
            try:
                ...
                external_id = response.get("id") if isinstance(
